...
bot.on("message", message => {
  if (message.content === "a!help") {
    const embed = new Discord.RichEmbed()
      .setColor("#38383a")
      .setImage(
        "https://cdn.discordapp.com/attachments/779089156525129809/821862209260224622/pccc.png"
      )
      .setThumbnail(
        "https://cdn.discordapp.com/attachments/779089156525129809/821862143468765211/firewall-icon.png"
...
bot.on("ready", () => {
  bot.user.setActivity(" a!help kurdish Security ✔", {
    type: "PLAYING"
  });
  bot.user.setStatus();
});
...
bot.on("message", message => {
  if (message.content.startsWith(prefix + "antibots on")) {
    ...
    message.channel.send(`**  You have enable anti bot!**`);
...
bot.on("message", message => {
  if (message.content === "a!invite") {
    ...
    let embed = new Discord.RichEmbed()
      ...
      .setTitle("• BOT INVITE •")
      .setURL(
        "https://discord.com/api/oauth2/authorize?client_id=821129666349498379&permissions=8&scope=bot"
...
bot.on("message", message => {
  if (message.content === "a!server") {
    ...
    let embed = new Discord.RichEmbed()
      .setColor("#38383a")
      .setTitle("• S𝗎𝗉𝗉𝗈𝗋𝗍 Serve •")
      .setURL(
        "https://discord.gg/tmy7NZWY"
      ) // Type Your Link here after ''
      .setThumbnail(
        "https://cdn.discordapp.com/attachments/779089156525129809/821862143468765211/firewall-icon.png"
      )
...
bot.on("message", async console => {
  ...
  if (console.content === "a!about") {
    ...
    var embed = new Discord.RichEmbed()
      ...
      .addField("**Name** ", "<@821129666349498379>")

      .addField("**ID** ", "821129666349498379")

      .addField("**Guilds** ", `${bot.guilds.size}`)

      .addField("**Users** ", `${bot.users.size}`)

      .addField("**Owner Bot** ", "<@740965290359128136>")
...
//////============token================////
bot.login("ODIxMTI5NjY2MzQ5NDk4Mzc5.YE_OmA.D9tUudVZKWvloFBWJFpPy5yFvMM");
